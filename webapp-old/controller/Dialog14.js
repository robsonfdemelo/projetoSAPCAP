sap.ui.define([
    ...
    return ManagedObject.extend("com.sap.build.standard.adminEngine.controller.Dialog14", {
        ...
        onCreate: function () {
            if (this.getView().byId("deposito").getValue() == "" ) {
                ...
                var oList = this.getView().byId("depositoTable"),
                ...
                if (oList.getItems()[0]) {
                    ...
                    for (var i = 0; i < oList.getItems()[0].getBindingContext().getBinding().aContexts.length; i++) {
                        ...
                        //sPath = sPath.replace("')", "");
                        var vdeposito = oList.getItems()[i].getBindingContext().getProperty("lgort");
                        if (vdeposito == this.getView().byId("deposito").getValue()) {
                            exists = true;
                            break;
                        }
                    }
                ...
                if (exists == false) {
                    var oContext = oBinding.create({
                        "mandt": "XXX",
                        "lgort": this.getView().byId("deposito").getValue(),
