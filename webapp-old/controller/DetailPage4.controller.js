sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    "../libs/jszip",
    "../libs/xlsx"
], function (BaseController, MessageBox, Dialog7, Utilities, History, Export, ExportTypeCSV, exportLibrary, Spreadsheet, jszipjs, xlsxjs) {
    "use strict";
    var EdmType = exportLibrary.EdmType;
    var excelImported = "";
    return BaseController.extend("com.sap.build.standard.adminEngine.controller.DetailPage4", {
        ...
        _onOverflowToolbarButtonPress: function (oEvent) {
            ...
            this.mDialog7 = this.mDialog7 || {};
            var oDialog = this.mDialog7[sDialogName];
            if (!oDialog) {
                oDialog = new Dialog7(this.getView());
                this.mDialog7[sDialogName] = oDialog;

                // For navigation.
                oDialog.setRouter(this.oRouter);
            } else {
                this.getView().byId("tipoWo").setValue("");
            }
        ...
        onExportOdataV4: function () {
            ...
            if (!this._oTable) {
                this._oTable = this.byId('tipoWoTable');
            }
        ...
        generateTableCsv: function () {
            var that = this;
            var oTable = that.getView().byId("tipoWoTable");
                    ...
                    if (oColumns[0] == "tipoWo") {
                        ...
                        oListBinding.attachCreateCompleted(function (oEvent) {
                            ...
                            if (oEvent.getParameter("success")) {
                                ...
                                that.byId("tipoWoTable").getBinding("items").resetChanges();
                                //   sap.ui.getCore().getMessageManager().removeAllMessages();
                            }
                        }.bind(this));
                        //var  oContext = "";
        ...
        onSave: function () {
            ...
            this.getView().getModel().submitBatch("TipoWoBaixaAutomaticaGroup").then(fnSuccess, fnError);
            //this._bTechnicalErrors = false; // If there were technical errors, a new save resets them.
        },
        onResetChanges: function () {
            this.byId("tipoWoTable").getBinding("items").resetChanges();
        ...
        setHeaderContext: function () {
            ...
            oView.byId("titleCount").setBindingContext(
                oView.byId("tipoWoTable").getBinding("items").getHeaderContext());
        },
