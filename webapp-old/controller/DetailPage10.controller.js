sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    'sap/ui/model/Sorter',
    'sap/ui/model/Filter'
], function (BaseController, MessageBox, Dialog13, Utilities, History, Export, ExportTypeCSV, exportLibrary, Spreadsheet, jszipjs, xlsxjs, Sorter, Filter) {
    "use strict";
    ...
    return BaseController.extend("com.sap.build.standard.adminEngine.controller.DetailPage10", {
        ...
        _onOverflowToolbarButtonPress: function (oEvent) {
            ...
            if (!oDialog) {
                ...
                this.getView().byId("cnpj").setValue("");
                this.getView().byId("centro").setValue("");
        ...
        onExportOdataV4: function () {
            ...
            if (!this._oTable) {
                this._oTable = this.byId('cnpjTable');
            }
        ...
        _import: function (file) {
            ...
            if (file && window.FileReader) {
                ...
                reader.onload = function (e) {
                    ...
                    var oColumns = Object.keys(oModelData["CNPJ"][0]);
                    if (oColumns[0] == "cnpj" &&
                        oColumns[1] == "centro" &&
                        oColumns[2] == "unidade") {
                        ...
                        var oModel = that.getView().getModel();
                        var oListBinding = oModel.bindList("/importCNPJ", undefined, undefined, undefined, { $$updateGroupId: "cnpjExcel" });
                            ...
                            if (oEvent.getParameter("success")) {
                                MessageBox.show(
                                    ...
                                    onClose: function (oAction) {
                                        var oListBinding = that.getView().getModel().bindList("/upsert_cnpj()", undefined, undefined, undefined, undefined);
                        ...
                        if (excelData.length > 0) {
                            //that.onSave();
                            that.getView().getModel().submitBatch("cnpjExcel");
                        }
                    } else {
                        sap.m.MessageBox.show(
        ...
        onSave: function () {
            ...
            this.getView().getModel().submitBatch("REMOTECENTROVSCNPJGroup").then(fnSuccess, fnError);
            //this._bTechnicalErrors = false; // If there were technical errors, a new save resets them.
        },
        onResetChanges: function () {
            this.byId("cnpjTable").getBinding("items").resetChanges();
        ...
        setHeaderContext: function () {
            ...
            oView.byId("titleCount").setBindingContext(
                oView.byId("cnpjTable").getBinding("items").getHeaderContext());
        }
    });
}, /* bExport= */ true);
