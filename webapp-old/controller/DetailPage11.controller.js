sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    'sap/ui/model/Sorter',
    'sap/ui/model/Filter'
], function (BaseController, MessageBox, Dialog14, Utilities, History, Export, ExportTypeCSV, exportLibrary, Spreadsheet, jszipjs, xlsxjs, Sorter, Filter) {
    "use strict";
    ...
    return BaseController.extend("com.sap.build.standard.adminEngine.controller.DetailPage11", {
        ...
        _onOverflowToolbarButtonPress: function (oEvent) {
            ...
            this.mDialog14 = this.mDialog14 || {};
            var oDialog = this.mDialog14[sDialogName];
            if (!oDialog) {
                oDialog = new Dialog14(this.getView());
                this.mDialog14[sDialogName] = oDialog;
        ...
        onExportOdataV4: function () {
            ...
            if (!this._oTable) {
                this._oTable = this.byId('depositoTable');
            }
        ...
        generateTableCsv: function () {
            var that = this;
            var oTable = that.getView().byId("depositoTable");
        ...
        _import: function (file) {
            ...
            if (file && window.FileReader) {
                ...
                reader.onload = function (e) {
                    ...
                    var oColumns = Object.keys(oModelData["DEPOSITO"][0]);
                    if (oColumns[0] == "lgort" ) {
                        var oGlobalBusyDialog = new sap.m.BusyDialog();
                        oGlobalBusyDialog.open();
                        var oModel = that.getView().getModel();
                        var oListBinding = oModel.bindList("/importDeposito", undefined, undefined, undefined, { $$updateGroupId: "depositoExcel" });
                            ...
                            if (oEvent.getParameter("success")) {
                                MessageBox.show(
                                    ...
                                    onClose: function (oAction) {
                                        var oListBinding = that.getView().getModel().bindList("/upsert_deposito()", undefined, undefined, undefined, undefined);
                                ...
                                that.byId("depositoTable").getBinding("items").resetChanges();
                                //   sap.ui.getCore().getMessageManager().removeAllMessages();
                            }
                        }.bind(this));
                        //var  oContext = "";
                        ...
                        if (excelData.length > 0) {
                            //that.onSave();
                            that.getView().getModel().submitBatch("depositoExcel");
                        }
                    } else {
                        sap.m.MessageBox.show(
        ...
        onSave: function () {
            ...
            this.getView().getModel().submitBatch("REMOTEDEPOSITOSGroup").then(fnSuccess, fnError);
            //this._bTechnicalErrors = false; // If there were technical errors, a new save resets them.
        },
        onResetChanges: function () {
            this.byId("depositoTable").getBinding("items").resetChanges();
        ...
        setHeaderContext: function () {
            ...
            oView.byId("titleCount").setBindingContext(
                oView.byId("depositoTable").getBinding("items").getHeaderContext());
        }
    });
}, /* bExport= */ true);
