sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    "../libs/jszip",
    "../libs/xlsx"
], function (BaseController, MessageBox, Dialog13, Utilities, History, Export, ExportTypeCSV, exportLibrary, Spreadsheet, jszipjs, xlsxjs) {
    "use strict";
    var EdmType = exportLibrary.EdmType;
    var excelImported = "";
    return BaseController.extend("com.sap.build.standard.adminEngine.controller.DetailPage10", {
        ...
        _onOverflowToolbarButtonPress: function (oEvent) {
            ...
            this.mDialog13 = this.mDialog13 || {};
            var oDialog = this.mDialog13[sDialogName];
            if (!oDialog) {
                oDialog = new Dialog13(this.getView());
                this.mDialog13[sDialogName] = oDialog;
        ...
        onInit: function () {
            ...
            this.oRouter.getTarget("DetailPage10").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
        ...
        onDataExport: function (oEvent) {
            var oListBinding = this.getView().getModel().bindList("/FornecedorBaixaAutomatica", undefined, undefined, undefined, { $select: "*" });
            var oData = [];
            oListBinding.requestContexts().then(function (aContexts) {
                aContexts.forEach(function (oContext) {
                    oData.push(oContext.getObject());
        ...
        onExportJson: function () {
            ...
            oSettings = {
                ...
                dataSource: aData.FornecedorBaixaAutomatica,
        ...
        onExportOdataV4: function () {
            ...
            if (!this._oTable) {
                this._oTable = this.byId('fornecedorTable');
            }
        ...
        generateTableCsv: function () {
            var that = this;
            var oTable = that.getView().byId("fornecedorTable");
        ...
        _import: function (file) {
            ...
            if (file && window.FileReader) {
                ...
                reader.onload = function (e) {
                    ...
                    var oModelo = new sap.ui.model.json.JSONModel({
                        FornecedorBaixaAutomatica: excelData
                    });
                    var oModelData = oModelo.getProperty("/");
                    var oColumns = Object.keys(oModelData["FornecedorBaixaAutomatica"][0]);
                    if (oColumns[0] == "fornecedor") {
                        var oGlobalBusyDialog = new sap.m.BusyDialog();
                        oGlobalBusyDialog.open();
                        var oModel = that.getView().getModel();
                        var oListBinding = oModel.bindList("/importFornecedorBaixaAutomatica", undefined, undefined, undefined, { $$updateGroupId: "fornecedorExcel" });
                        ...
                        oListBinding.attachCreateCompleted(function (oEvent) {
                            ...
                            if (oEvent.getParameter("success")) {
                                ...
                                that.byId("fornecedorTable").getBinding("items").resetChanges();
                                //   sap.ui.getCore().getMessageManager().removeAllMessages();
                            }
                        }.bind(this));
                        //var  oContext = "";
                        ...
                        if (excelData.length > 0) {
                            //that.onSave();
                            that.getView().getModel().submitBatch("fornecedorExcel");
                        }
                    } else {
                        sap.m.MessageBox.show(
        ...
        onSave: function () {
            ...
            this.getView().getModel().submitBatch("FornecedorBaixaAutomaticaGroup").then(fnSuccess, fnError);
            //this._bTechnicalErrors = false; // If there were technical errors, a new save resets them.
        },
        onResetChanges: function () {
            this.byId("fornecedorTable").getBinding("items").resetChanges();
        ...
        setHeaderContext: function () {
            ...
            oView.byId("titleCount").setBindingContext(
                oView.byId("fornecedorTable").getBinding("items").getHeaderContext());
        },
            ...
            MessageBox.warning("Tem certeza que seja excluir toda a lista? É recomendado realizar o download dos dados antes de prosseguir", {
                ...
                onClose: function (sAction) {
                    if (sAction == "OK") {
                        ...
                        oGlobalBusyDialog.open();
                        var oModel = that.getView().getModel();
                        var oListBinding = oModel.bindList("/killFornecedorBaixaAutomatica", undefined, undefined, undefined, { $select: "*" });
