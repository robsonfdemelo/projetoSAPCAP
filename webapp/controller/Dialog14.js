sap.ui.define([
    ...
    return ManagedObject.extend("com.sap.build.standard.adminEngine.controller.Dialog14", {
        constructor: function (oView) {
            this._oView = oView;
            this._oControl = sap.ui.xmlfragment(oView.getId(), "com.sap.build.standard.adminEngine.view.Dialog14", this);
            this._bInit = false;
        },
        ...
        onCreate2: function () {
            ...
            var oListBinding = oModel.bindList("/AlteracaoTecnico", undefined, undefined, undefined, { $$updateGroupId: "alteracaoTecGroup" });
            var that = this;
                    ...
                    MessageBox.show(
                        ...
                        onClose: function (oAction) {
                            var oTable = that.getView().byId("LoginCnpjTable"),
                                ...
                                aFilters = [];
                            var oFilter = new sap.ui.model.Filter("loginTecnico", sap.ui.model.FilterOperator.NE, "all");
            ...
            var oContext = oListBinding.create({
                ...
                "CNPJ": that.getView().byId("idCnpj").getValue(),
            });
            oModel.submitBatch("alteracaoTecGroup");
            this._oControl.close();
        },
        ...
        _handleValueHelpClose: function (evt) {
            ...
            if (oSelectedItem) {
                ...
                that.getView().byId("idCnpj").setValue(oSelectedItem.getInfo());
            }
